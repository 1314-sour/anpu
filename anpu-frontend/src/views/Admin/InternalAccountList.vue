  ...
  <div class="internal-account-page">
    ...
    <div class="filter-container">
      ...
      <el-select 
        ...
        <el-option label="运维人员" value="运维人员"></el-option>
      </el-select>
      
      <el-select 
        v-model="searchForm.company" 
        placeholder="安普科技管理公司" 
        style="width: 200px; margin-right: 10px;" 
        size="small"
        clearable>
        <el-option label="安普科技管理公司" value="安普科技管理公司"></el-option>
      </el-select>
    ...
    <el-table 
      ...
      <el-table-column prop="securityZone" label="安全区" min-width="100"></el-table-column>
      ...
      <el-table-column prop="dept" label="部门" min-width="100"></el-table-column>
    ...
    <el-dialog
      ...
      <el-form :model="form" :rules="rules" ref="accountForm" label-width="120px">
        ...
        <el-form-item label="安全区：" prop="securityZone">
          <el-input v-model="form.securityZone" placeholder="请输入安全区"></el-input>
        </el-form-item>
